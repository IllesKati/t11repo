...
let month=prompt("Add meg a hónapot:");
function Csatlakozas()
{
	let csatlakozas=true;
    for(let i=0;i<EuropaiUnio.length;i++){
    	if(EuropaiUnio[i].csatlakozas.includes(month)){
        	csatlakozas=true;
                    	return true;
        }
    }
...
EredmenyKiiro(Csatlakozas(), "Ebben a hónapban történt csatlakozás.", "Ebben a hónapban nem történt csatlakozás.");
