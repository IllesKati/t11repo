...
let datum=prompt("Add meg az aktuális dátumot:");
function Csatlakozas()
{
	let csatlakozas=true;
    for(let i=0;i<EuropaiUnio.length;i++){
    	if(EuropaiUnio[i].csatlakozas.startsWith(datum)){
        	csatlakozas=true;
                    	return true;
        }
    }
...
EredmenyKiiro(Csatlakozas(), "Történt csatlakozás ebben az évben.", "Nem történt csatlakozás.");
